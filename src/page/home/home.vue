  ...
  <div class="home">
    ...
    <div class="_center pr">
      ...
      <Row>
        ...
        <Col span="8">
          <Input v-model="search.text" icon="ios-search-strong" placeholder="" class="_search" @on-click="resSearch" @keyup.enter.native="resSearch" placeholder="案件编号 / 申请人 / 被申请人"></Input>
        </Col>
        <Col span="6">
