<template>
  <div class="pr _editAgenInfo">
    <Row>
      ...
      <Col span="10" offset="2">
        ...
        <Row class="_labelFor">
          ...
          <Col span="24">
            <Select :value="1">
              <Option :value="1">{{agenData.propName}}</Option>
            </Select>
          </Col>
          <!-- <Col span="24">
    ...
    <edit-agen-appl-book :caseId="caseId" :infoId="agenData.id" :editApplBookData="editAgenData.authorizeBook" :fileType="['jpg','jpeg','png','pdf']" :uploadFileUrl="uploadFileUrl" @saveClick="editApplBookSave" @delFileClick="delFileSave"></edit-agen-appl-book>
    <Row>
...
import editAgenApplBook from '@/page/caseInfo/children/children/editAgenApplBook'
import setRegExp from '@/config/regExp.js'
import regi from '@/config/regiType.js'

export default {
  name: 'edit_agen_info',
  components: { editAgenApplBook },
  ...
  computed: {
    uploadFileUrl () {
      return regi.api + '/proxy/filePreUpload'
    }
  },
  methods: {
    delFileSave () {
    ...
    sendAjax () {
      axios.post('/proxy/updateProxyOrFile', {
        caseId: this.caseId,
        id: this.agenData.id,
