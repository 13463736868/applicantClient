      ...
      <div v-if="endCaseD !== null" class="_mid">
        <Row>
          <Col span="22" offset="1">
            <p>结案方式：<span v-text="endCaseD.caseDocumentType"></span></p>
            <p>结案日期：<span v-text="endCaseD.endCaseDate"></span></p>
            <p>结案文书：<span class="_file" v-text="endCaseD.filename" @click="seeFile(endCaseD.filepath)"></span><Icon @click="dowFile(endCaseD.fileId)" class="_dowFile" type="archive"></Icon></p>
          </Col>
        </Row>
      </div>
    </div>
