          ...
          <Col span="22" offset="1">
            ...
            <p>
              <Row>
                ...
                <Col span="18">
                  <span v-if="infoData.authorizeBook !== undefined && infoData.authorizeBook !== null" @click="seeFile(infoData.authorizeBook.filepath)" class="_autBook" v-text="infoData.authorizeBook.filename > 25 ? infoData.authorizeBook.filename.substr(0, 20) + '...' : infoData.authorizeBook.filename"></span>
                </Col>
              </Row>
            </p>
          </Col>
